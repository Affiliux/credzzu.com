        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className='min-w-[150px]'>Localidade</TableHead>
              ...
              <TableRow>
                <TableCell colSpan={6} className='h-40 px-4'>
                  <div className='flex flex-col items-start md:items-center'>
                    <p className='text-center text-base text-neutral-400 sm:text-sm'>Nenhum devedor cadastrado</p>
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align='end'>
                        ...
                        <DropdownMenuItem onClick={() => onCreateDebt(debtor)}>
                          <Plus className='mr-2 h-4 w-4' />
                          Criar dívida
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => onViewDebts(debtor)}>
                          <Link className='mr-2 h-4 w-4' />
                          Visualizar dívidas
                        </DropdownMenuItem>
                        <DropdownMenuSeparator />
                        <DropdownMenuItem className='text-red-500' onClick={() => onDelete(debtor.id!)}>
