        ...
        <Table>
          <TableHeader>
            <TableRow className='border-emerald-500/10 hover:bg-emerald-500/5'>
              ...
              <TableHead className='min-w-[150px] text-white/80'>Valor</TableHead>
              <TableHead className='min-w-[150px] text-white/80'>Primeira parcela</TableHead>
              <TableHead className='min-w-[150px] text-white/80'>Status</TableHead>
              <TableHead className='min-w-[150px] text-white/80'>Parcelas</TableHead>
            ...
            {is_loading ? (
              Array.from({ length: 5 }).map((_, index) => (
                <TableRow key={index} className='border-emerald-500/10'>
                  ...
                  <TableCell>
                    <Skeleton className='h-4 w-[100px] bg-emerald-500/10' />
                  </TableCell>
                  <TableCell>
                    <Skeleton className='h-4 w-[80px] bg-emerald-500/10' />
                  </TableCell>
                  <TableCell>
              ...
              <TableRow>
                <TableCell colSpan={6} className='h-40 px-4'>
                  <div className='flex flex-col items-center'>
                    <p className='text-center text-base text-white/60 sm:text-sm'>Nenhuma dívida cadastrada</p>
              ...
              data?.map(debt => (
                ...
                >
                  <TableCell className='max-w-[200px] truncate font-medium'>{debt.description || '-'}</TableCell>
                  <TableCell className='max-w-[150px] truncate'>{formatCurrency(debt.totalValue)}</TableCell>
                  <TableCell className='max-w-[150px] truncate'>
                    {new Date(debt.dateOfDebt).toLocaleDateString('pt-BR')}
                  </TableCell>
                  <TableCell className='max-w-[150px] truncate'>
                    {getStatusBadge(debt.status || DebtStatusEnum.ACTIVE)}
                  </TableCell>
                  <TableCell className='max-w-[100px] truncate'>{debt.installmentsNumber}x</TableCell>
                  <TableCell>
                    <DropdownMenu>
